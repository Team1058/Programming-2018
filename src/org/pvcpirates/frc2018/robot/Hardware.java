...
public class Hardware {
	...
	// public final Solenoid climberSolenoid = new
	// Solenoid(RobotMap.PneumaticIds.CLIMBER);
	...
	private Hardware() {
		...
		// Set hard limit (limit switch) so that we don't attempt to retract
		...
		armExtendMotor.configReverseLimitSwitchSource(LimitSwitchSource.FeedbackConnector,
				LimitSwitchNormal.NormallyClosed, ROBOT_TIMEOUT);
		armExtendMotor.configForwardLimitSwitchSource(LimitSwitchSource.FeedbackConnector,
				LimitSwitchNormal.NormallyClosed, ROBOT_TIMEOUT);
		...
		wristPivotMotor.configReverseLimitSwitchSource(LimitSwitchSource.FeedbackConnector,
