...
public class DriveOpenLoop extends TeleopCommand {
    ...
    @Override
    public void exec() {
        double fb = GamepadHelper.applyDeadBand(gamepad.getAxis(GamepadEnum.RIGHT_STICK_X), .15);
        double lr = GamepadHelper.applyDeadBand(gamepad.getAxis(GamepadEnum.LEFT_STICK_Y), .15);
